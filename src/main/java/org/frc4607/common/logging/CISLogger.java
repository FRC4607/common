...
public class CISLogger {
     ...
     */
    public CISLogger(String name, String[] labels) throws IOException {
        if (!isReady()) {
    ...
    public void logTelemetry(Object[] data) {
        ...
        sb.append(LocalTime.now().truncatedTo(ChronoUnit.SECONDS).toString());
    ...
    public void logMessage(String message) {
        logInternal("1," + LocalTime.now().truncatedTo(ChronoUnit.SECONDS).toString() + "," + csvEscape(message));
    }
